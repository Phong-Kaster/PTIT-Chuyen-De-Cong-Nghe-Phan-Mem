...
{
    public partial class BangGiaTrucTuyen : DevExpress.XtraEditors.XtraForm
    {
        ...
        {
            this.Validate();
            this.bangGiaTrucTuyenBindingSource1.EndEdit();
            this.tableAdapterManager1.UpdateAll(this.chungKhoanDataSet1);
        ...
        private void BangGiaTrucTuyen_Load(object sender, EventArgs e)
        {
            ...
            this.bangGiaTrucTuyenTableAdapter1.Fill(this.chungKhoanDataSet1.BangGiaTrucTuyen);
        ...
        private void bangGiaTrucTuyenBindingSource1BindingNavigatorSaveItem_Click(object sender, EventArgs e)
        {
            this.Validate();
            this.bangGiaTrucTuyenBindingSource1.EndEdit();
            this.tableAdapterManager1.UpdateAll(this.chungKhoanDataSet1);
        ...
        private void BangGiaTrucTuyen_Load_1(object sender, EventArgs e)
        {
            // TODO: This line of code loads data into the 'chungKhoanDataSet1.BangGiaTrucTuyen' table. You can move, or remove it, as needed.
            this.bangGiaTrucTuyenTableAdapter1.Fill(this.chungKhoanDataSet1.BangGiaTrucTuyen);

...
{
    public partial class BangGiaCoPhieuTrucTuyen : DevExpress.XtraEditors.XtraForm
    {
        ...
        /*Tuyệt đối không dùng select * from dbo.BangGiaTrucTruyen vì sẽ gây tràn bộ nhớ*/
        ...
        public BangGiaCoPhieuTrucTuyen()
        {
            InitializeComponent();
        }
        ...
        private void BangGiaCoPhieuTrucTuyen_Load(object sender, EventArgs e)
        {
